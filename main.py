...
def main():
    ...
    airplane = AirPlane(velocities=[
        velocity*2 for velocity in range(1, 21)],
        Nh=[0.086767, 0.17147, 0.25282, 0.32988, 0.40197, 0.46852, 0.52904, 0.58303, 0.62991,
            0.66894, 0.69904, 0.71862, 0.72522, 0.71483, 0.68056, 0.60971, 0.47616, 0.21686, 0, 0],
        Pe=[734.82, 733.93, 731.74, 727.75, 721.48, 712.5, 700.37, 684.68, 665.03,
    ...
    envelope = Envelope(makedata=makedata, visualization=visual)
    envelope.find_envelope(alt=0.0)
    envelope.find_envelope(alt=600.0)
    #envelope.find_envelope_all()
